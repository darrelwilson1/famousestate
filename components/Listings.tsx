...
const properties: Property[] = [
  ...
  },
  {
    ...
    alt: "Modernist hillside estate at dusk",
    tag: "Pre-Listing",
  },
  {
    name: "Cap Ferrat 7",
    ...
    alt: "Cliffside compound overlooking the sea",
    tag: "Private",
  },
  {
    name: "The Linden",
    ...
    alt: "Georgian townhouse with private garden",
    tag: "Off-Market",
  },
];
          ...
          >
            <div className="relative aspect-[3/4] w-full overflow-hidden bg-ink-soft">
              ...
              <span className="absolute right-5 top-5 font-serif text-sm">
                {String(i + 1).padStart(2, "0")} <span className="text-bone/40">/ {String(properties.length).padStart(2, "0")}</span>
              </span>
            </div>
